...
python3 view_som.py painters/base_soms/out.pt       -hl -o painters/imgs/soms/out.png
...
python3 view_som.py painters/base_soms/out.pt       -hl -o painters/imgs/freqs/out.png       -d painters/dataset/ -m painters/model.pt -mc painters/model.py -n
