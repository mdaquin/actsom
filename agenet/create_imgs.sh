...
python3 view_som.py agenet/base_soms/net.layer1.pt -hl -o agenet/imgs/soms/net.layer1.png
python3 view_som.py agenet/base_soms/net.layer2.pt -hl -o agenet/imgs/soms/net.layer2.png
python3 view_som.py agenet/base_soms/net.layer3.pt -hl -o agenet/imgs/soms/net.layer3.png
python3 view_som.py agenet/base_soms/net.layer4.pt -hl -o agenet/imgs/soms/net.layer4.png
...
python3 view_som.py agenet/base_soms/net.layer3.pt -hl -o agenet/imgs/freqs/net.layer3.png -d agenet/dataset/ -m agenet/agenet_4.75_0.88 -mc agenet/model.py -n
python3 view_som.py agenet/base_soms/net.layer4.pt -hl -o agenet/imgs/freqs/net.layer4.png -d agenet/dataset/ -m agenet/agenet_4.75_0.88 -mc agenet/model.py -n
